    ...
    <>
      <div className="link-container">
        ...
        <p className="link-description">
          <span>Purpose:</span> The `Link` component is used to navigate between
          different routes in your application. It is a basic navigation
          component that updates the URL without causing a full page reload.
        </p>
        <p className="link-description">
